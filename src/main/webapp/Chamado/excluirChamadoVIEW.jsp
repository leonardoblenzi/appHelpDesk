...
<body>
	...
	<nav class="navbar navbar-dark bg-dark">
		<a class="navbar-brand" href="#"> <img
			src="../style/imagens/logo.png" width="30" height="30"
			class="d-inline-block align-top" alt=""> App Help Desk
		</a>
	...
	<div class="container">
		<div class="row">
			...
			<div class="card-consultar-chamado">
				<div class="card">
					<div class="card-header">Tem certeza que deseja excluir esse
						chamado ?</div>
					...
					int idUsuario = chamadoDTO.getId_usuario();
					UsuarioDAO usuarioDAO = new UsuarioDAO();
					//pegando informações do usuario pelo id
						...
						<div class="col-md-12 card-body">
							...
							<div class="card mb-3 bg-light">
								...
								<div class="card-body">
									...
									<form action="excluirChamado.jsp" method="POST">


										<div class="form-group">
											<label class="font-weight-bold">ID Chamado</label> <input
												type="text" readonly class="form-control-plaintext"
												name="id_chamado" value="<%=chamadoDTO.getId_chamado()%>">
										</div>


										<div class="form-group">
											<label class="font-weight-bold">Titulo</label> <input
												type="text" readonly class="form-control-plaintext"
												name="titulo" value="<%=chamadoDTO.getTitulo()%>">
										</div>

										<div class="form-group">
											<label class="font-weight-bold">Categoria</label> <input
												type="text" readonly class="form-control-plaintext"
												name="categoia" value="<%=chamadoDTO.getCategoria()%>">
										</div>

										<div class="form-group">
											<label class="font-weight-bold">Descricao</label> <input
												type="text" readonly class="form-control-plaintext"
												name="descricao" value="<%=chamadoDTO.getDescricao()%>">
										</div>

										<div class="form-group">
											<label class=font-weight-bold>ID Usuario: </label>
											<%=chamadoDTO.getId_usuario()%>
